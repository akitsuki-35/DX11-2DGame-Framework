...
//ID3D11Buffer* Sprite::pVertexBuffer{ nullptr }; // 頂点バッファ
...
//}
//
//void Sprite::Draw(Texture* pTexture, const DirectX::XMFLOAT2& position, const DirectX::XMFLOAT2& size, const float& angle, const DirectX::XMFLOAT4& color)
//{
//	pTexture->SetTexture();
//
//	// シェーダーを描画パイプラインに設定
...
//}
//
//void Sprite::Draw(Texture* pTexture, const DirectX::XMFLOAT2& position, const float& angle, const float& scale, const DirectX::XMFLOAT4& color)
//{
//	pTexture->SetTexture();
//
//	// シェーダーを描画パイプラインに設定
...
//void Sprite::Draw(SpriteSheet* pSpriteSheet, const DirectX::XMFLOAT2& position, const DirectX::XMUINT2& patternNum, DirectX::XMFLOAT2 size, const float& angle, const DirectX::XMFLOAT4& color)
//{
//}
//
//void Sprite::Draw(SpriteSheet* pSpriteSheet, const DirectX::XMFLOAT2& position, const DirectX::XMUINT2& patternNum, const float& angle, const float& scale, const DirectX::XMFLOAT4& color)
//{
//}
//
//void Sprite::Draw(SpriteSheet* pSpriteSheet, const DirectX::XMFLOAT2& position, const int& patternNum, DirectX::XMFLOAT2 size, const float& angle, const DirectX::XMFLOAT4& color)
//{
//}
//
//void Sprite::Draw(SpriteSheet* pSpriteSheet, const DirectX::XMFLOAT2& position, const int& patternNum, const float& angle, const float& scale, const DirectX::XMFLOAT4& color)
//{
//}